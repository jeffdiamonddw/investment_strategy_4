...
PARETO_INPUT_FILE = 'analysis/top_ranked_17_year.csv' # The file you extracted
...
if __name__ == "__main__":
    ...
    X_all, df_perturb = generate_perturbations(df_pareto,   NUM_PERTURBATIONS, XL_DEFAULT, XU_DEFAULT)
